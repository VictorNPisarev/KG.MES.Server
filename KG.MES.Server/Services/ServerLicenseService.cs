...
public class ServerLicenseService : ILicenseService
{
	private readonly AppDbContext _context;
	private readonly ILogger<ServerLicenseService> _logger;

	public ServerLicenseService(AppDbContext context, ILogger<ServerLicenseService> logger)
	{
		_context = context;
		_logger = logger;
	}
